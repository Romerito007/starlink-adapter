...
const file_spacex_api_device_dish_config_proto_rawDesc = "" +
	"\n" +
	"#spacex/api/device/dish_config.proto\x12\x11SpaceX.API.Device\"\xe9\b\n" +
	"\n" +
	"DishConfig\x12P\n" +
	...
	"\x15apply_power_save_mode\x18\xf1. \x01(\bR\x12applyPowerSaveMode\x12L\n" +
	"#swupdate_three_day_deferral_enabled\x18\a \x01(\bR\x1fswupdateThreeDayDeferralEnabled\x12X\n" +
	")apply_swupdate_three_day_deferral_enabled\x18\xd96 \x01(\bR$applySwupdateThreeDayDeferralEnabled\"7\n" +
	"\fSnowMeltMode\x12\b\n" +
	"\x04AUTO\x10\x00\x12\r\n" +
