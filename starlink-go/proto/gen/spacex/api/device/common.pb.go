...
const file_spacex_api_device_common_proto_rawDesc = "" +
	...
	"\rdish_cohoused\x18\r \x01(\bR\fdishCohoused\"(\n" +
	...
	"\bepoch_id\x18\x02 \x01(\x04R\aepochId\"\xfb\x03\n" +
	"\bBootInfo\x12V\n" +
	...
	"\x10crash_boot_count\x18\x06 \x01(\x05R\x0ecrashBootCount\x1a@\n" +
	...
	"\x11SOFTWARE_WATCHDOG\x10\r\"\x04\b\n" +
	"\x10\n" +
...
var file_spacex_api_device_common_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_spacex_api_device_common_proto_goTypes = []any{
	...
	(*WifiNetworkInterface_InvalidPacketCounts)(nil), // 27: SpaceX.API.Device.WifiNetworkInterface.InvalidPacketCounts
}
var file_spacex_api_device_common_proto_depIdxs = []int32{
	...
	27, // 12: SpaceX.API.Device.WifiNetworkInterface.invalid_packet_counts:type_name -> SpaceX.API.Device.WifiNetworkInterface.InvalidPacketCounts
