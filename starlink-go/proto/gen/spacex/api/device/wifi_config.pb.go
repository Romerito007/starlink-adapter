...
const file_spacex_api_device_wifi_config_proto_rawDesc = "" +
	...
	" \x01(\bR\x10supports5ghzHighJ\x04\b\x06\x10\aJ\x04\b\b\x10\t\"\xb8B\n" +
	"\n" +
	"WifiConfig\x12!\n" +
	...
	"\x1dapply_disable_mesh_onboarding\x18\xab\b \x01(\bR\x1aapplyDisableMeshOnboarding\x12B\n" +
	...
	"\x15apply_debug_pop_pings\x18\xc7\b \x01(\bR\x12applyDebugPopPings\x12#\n" +
	"\rclient_tester\x18P \x01(\bR\fclientTester\x12/\n" +
	"\x13apply_client_tester\x18\xc8\b \x01(\bR\x11applyClientTester\x12\x10\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.SpaceX.API.Device.MeshConfigR\x05value:\x028\x01\x1a\xde\x04\n" +
	...
	"\x04authJ\x06\b\xe8\a\x10\xe9\aJ\x06\b\xe9\a\x10\xea\aJ\x06\b\xea\a\x10\xeb\aJ\x06\b\xec\a\x10\xed\aJ\x06\b\xee\a\x10\xef\aJ\x06\b\xd0\x0f\x10\xd1\x0fJ\x06\b\xf4\a\x10\xf5\aJ\x06\b\xf6\a\x10\xf7\aJ\x06\b\xf8\a\x10\xf9\a\x1a\x80\x04\n" +
	"\aNetwork\x12\x13\n" +
	"\x04ipv4\x18\xeb\a \x01(\tR\x04ipv4\x12\"\n" +
	"\fdhcpv4_start\x18\xf4\a \x01(\rR\vdhcpv4Start\x12$\n" +
	...
	"\x0flanding_page_v2\x18\xf9\a \x01(\bR\rlandingPageV2\x12\x1b\n" +
	"\binternal\x18\xf5\a \x01(\bR\binternal\x12\x13\n" +
	"\x04vlan\x18\xf6\a \x01(\rR\x04vlanJ\x06\b\xe8\a\x10\xe9\aJ\x06\b\xe9\a\x10\xea\aJ\x06\b\xea\a\x10\xeb\aJ\x06\b\xec\a\x10\xed\aJ\x06\b\xed\a\x10\xee\aJ\x06\b\xee\a\x10\xef\a\"9\n" +
	"\bSecurity\x12\v\n" +
	...
	"\ttransport\x18\x05 \x01(\x0e2\x1b.SpaceX.API.Device.ProtocolR\ttransport\"\x12\n" +
	"\x10NoTrafficControl\"\x9c\x02\n" +
	"\x0eAckSuppression\x12\x19\n" +
	"\back_mark\x18\x01 \x01(\rR\aackMark\x12+\n" +
	...
	"\x0fcake_manual_rtt\x18\x06 \x01(\x02R\rcakeManualRtt\"\x93\x02\n" +
	"\rCakeRateLimit\x12\x1b\n" +
	"\thost_mark\x18\x01 \x01(\rR\bhostMark\x12\x1c\n" +
...
var file_spacex_api_device_wifi_config_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_spacex_api_device_wifi_config_proto_goTypes = []any{
	...
	(*WifiConfig)(nil),                     // 9: SpaceX.API.Device.WifiConfig
	(*WeeklyBlockSchedule)(nil),            // 10: SpaceX.API.Device.WeeklyBlockSchedule
	(*ClientConfig)(nil),                   // 11: SpaceX.API.Device.ClientConfig
	(*ClientName)(nil),                     // 12: SpaceX.API.Device.ClientName
	(*AuthOpen)(nil),                       // 13: SpaceX.API.Device.AuthOpen
	(*AuthWpa2)(nil),                       // 14: SpaceX.API.Device.AuthWpa2
	(*AuthWpa3)(nil),                       // 15: SpaceX.API.Device.AuthWpa3
	(*AuthWpa2Wpa3)(nil),                   // 16: SpaceX.API.Device.AuthWpa2Wpa3
	(*AuthRadius)(nil),                     // 17: SpaceX.API.Device.AuthRadius
	(*NoTrafficControl)(nil),               // 18: SpaceX.API.Device.NoTrafficControl
	(*AckSuppression)(nil),                 // 19: SpaceX.API.Device.AckSuppression
	(*CakeRateLimit)(nil),                  // 20: SpaceX.API.Device.CakeRateLimit
	nil,                                    // 21: SpaceX.API.Device.WifiConfig.MeshConfigsEntry
	nil,                                    // 22: SpaceX.API.Device.WifiConfig.MeshConfigsUpdatesEntry
	(*WifiConfig_BasicServiceSet)(nil),     // 23: SpaceX.API.Device.WifiConfig.BasicServiceSet
	(*WifiConfig_Network)(nil),             // 24: SpaceX.API.Device.WifiConfig.Network
	(*WeeklyBlockSchedule_BlockRange)(nil), // 25: SpaceX.API.Device.WeeklyBlockSchedule.BlockRange
	(*PublicKey)(nil),                      // 26: SpaceX.API.Device.PublicKey
	(*BootInfo)(nil),                       // 27: SpaceX.API.Device.BootInfo
	(IfaceType)(0),                         // 28: SpaceX.API.Device.IfaceType
	(TxPowerLevel)(0),                      // 29: SpaceX.API.Device.TxPowerLevel
	(Protocol)(0),                          // 30: SpaceX.API.Device.Protocol
}
var file_spacex_api_device_wifi_config_proto_depIdxs = []int32{
	...
	21, // 1: SpaceX.API.Device.WifiConfig.mesh_configs:type_name -> SpaceX.API.Device.WifiConfig.MeshConfigsEntry
	22, // 2: SpaceX.API.Device.WifiConfig.mesh_configs_updates:type_name -> SpaceX.API.Device.WifiConfig.MeshConfigsUpdatesEntry
	26, // 3: SpaceX.API.Device.WifiConfig.dynamic_keys:type_name -> SpaceX.API.Device.PublicKey
	27, // 4: SpaceX.API.Device.WifiConfig.boot:type_name -> SpaceX.API.Device.BootInfo
	24, // 5: SpaceX.API.Device.WifiConfig.networks:type_name -> SpaceX.API.Device.WifiConfig.Network
	5,  // 6: SpaceX.API.Device.WifiConfig.wireless_mode_2ghz:type_name -> SpaceX.API.Device.WifiConfig.WirelessMode
	5,  // 7: SpaceX.API.Device.WifiConfig.wireless_mode_5ghz:type_name -> SpaceX.API.Device.WifiConfig.WirelessMode
	5,  // 8: SpaceX.API.Device.WifiConfig.wireless_mode_5ghz_high:type_name -> SpaceX.API.Device.WifiConfig.WirelessMode
	6,  // 9: SpaceX.API.Device.WifiConfig.ht_bandwidth_2ghz:type_name -> SpaceX.API.Device.WifiConfig.HTBandwidth
	6,  // 10: SpaceX.API.Device.WifiConfig.ht_bandwidth_5ghz:type_name -> SpaceX.API.Device.WifiConfig.HTBandwidth
	6,  // 11: SpaceX.API.Device.WifiConfig.ht_bandwidth_5ghz_high:type_name -> SpaceX.API.Device.WifiConfig.HTBandwidth
	7,  // 12: SpaceX.API.Device.WifiConfig.vht_bandwidth:type_name -> SpaceX.API.Device.WifiConfig.VHTBandwidth
	7,  // 13: SpaceX.API.Device.WifiConfig.vht_bandwidth_5ghz_high:type_name -> SpaceX.API.Device.WifiConfig.VHTBandwidth
	12, // 14: SpaceX.API.Device.WifiConfig.client_names:type_name -> SpaceX.API.Device.ClientName
	28, // 15: SpaceX.API.Device.WifiConfig.golden_iface_type:type_name -> SpaceX.API.Device.IfaceType
	29, // 16: SpaceX.API.Device.WifiConfig.tx_power_level_2ghz:type_name -> SpaceX.API.Device.TxPowerLevel
	29, // 17: SpaceX.API.Device.WifiConfig.tx_power_level_5ghz:type_name -> SpaceX.API.Device.TxPowerLevel
	29, // 18: SpaceX.API.Device.WifiConfig.tx_power_level_5ghz_high:type_name -> SpaceX.API.Device.TxPowerLevel
	11, // 19: SpaceX.API.Device.WifiConfig.client_configs:type_name -> SpaceX.API.Device.ClientConfig
	18, // 20: SpaceX.API.Device.WifiConfig.wan_no_traffic_control:type_name -> SpaceX.API.Device.NoTrafficControl
	19, // 21: SpaceX.API.Device.WifiConfig.wan_ack_suppression:type_name -> SpaceX.API.Device.AckSuppression
	20, // 22: SpaceX.API.Device.WifiConfig.wan_cake_rate_limit:type_name -> SpaceX.API.Device.CakeRateLimit
	25, // 23: SpaceX.API.Device.WeeklyBlockSchedule.block_ranges:type_name -> SpaceX.API.Device.WeeklyBlockSchedule.BlockRange
	10, // 24: SpaceX.API.Device.ClientConfig.weekly_block_schedules:type_name -> SpaceX.API.Device.WeeklyBlockSchedule
	30, // 25: SpaceX.API.Device.AuthRadius.transport:type_name -> SpaceX.API.Device.Protocol
	2,  // 26: SpaceX.API.Device.CakeRateLimit.priority_queue_parameter:type_name -> SpaceX.API.Device.CakePriorityQueueParameter
	1,  // 27: SpaceX.API.Device.CakeRateLimit.ack_filter:type_name -> SpaceX.API.Device.CakeAckFilter
	8,  // 28: SpaceX.API.Device.WifiConfig.MeshConfigsEntry.value:type_name -> SpaceX.API.Device.MeshConfig
	8,  // 29: SpaceX.API.Device.WifiConfig.MeshConfigsUpdatesEntry.value:type_name -> SpaceX.API.Device.MeshConfig
	13, // 30: SpaceX.API.Device.WifiConfig.BasicServiceSet.auth_open:type_name -> SpaceX.API.Device.AuthOpen
	14, // 31: SpaceX.API.Device.WifiConfig.BasicServiceSet.auth_wpa2:type_name -> SpaceX.API.Device.AuthWpa2
	15, // 32: SpaceX.API.Device.WifiConfig.BasicServiceSet.auth_wpa3:type_name -> SpaceX.API.Device.AuthWpa3
	16, // 33: SpaceX.API.Device.WifiConfig.BasicServiceSet.auth_wpa2_wpa3:type_name -> SpaceX.API.Device.AuthWpa2Wpa3
	17, // 34: SpaceX.API.Device.WifiConfig.BasicServiceSet.auth_radius:type_name -> SpaceX.API.Device.AuthRadius
	4,  // 35: SpaceX.API.Device.WifiConfig.BasicServiceSet.band:type_name -> SpaceX.API.Device.WifiConfig.Band
	23, // 36: SpaceX.API.Device.WifiConfig.Network.basic_service_sets:type_name -> SpaceX.API.Device.WifiConfig.BasicServiceSet
...
func file_spacex_api_device_wifi_config_proto_init() {
	...
	file_spacex_api_device_wifi_config_proto_msgTypes[1].OneofWrappers = []any{
		(*WifiConfig_WanNoTrafficControl)(nil),
		(*WifiConfig_WanAckSuppression)(nil),
		(*WifiConfig_WanCakeRateLimit)(nil),
	}
	file_spacex_api_device_wifi_config_proto_msgTypes[15].OneofWrappers = []any{
