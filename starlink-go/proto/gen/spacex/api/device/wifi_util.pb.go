...
type RadiusStatsMap struct {
	state         protoimpl.MessageState                 `protogen:"open.v1"`
	RadiusStats   map[string]*RadiusStatsMap_RadiusStats `protobuf:"bytes,1,rep,name=radius_stats,json=radiusStats,proto3" json:"radius_stats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_spacex_api_device_wifi_util_proto_rawDesc = "" +
	...
	"\amac_lan\x18\x03 \x01(\tR\x06macLan\x12\x1d\n" +
	"\n" +
	"iface_name\x18\x04 \x01(\tR\tifaceName\x12;\n" +
	"\n" +
	"iface_type\x18\x05 \x01(\x0e2\x1c.SpaceX.API.Device.IfaceTypeR\tifaceType\x12\x18\n" +
	"\achannel\x18\x06 \x01(\rR\achannel\x12\x1e\n" +
	"\n" +
	...
	"\fexpires_time\x18\x04 \x01(\tR\vexpiresTime\x12\x16\n" +
	"\x06active\x18\x05 \x01(\bR\x06active\x12\x1b\n" +
	"\tclient_id\x18\x06 \x01(\rR\bclientId\"r\n" +
	"\n" +
	"DhcpServer\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12\x16\n" +
	"\x06subnet\x18\x02 \x01(\tR\x06subnet\x124\n" +
	"\x06leases\x18\x03 \x03(\v2\x1c.SpaceX.API.Device.DhcpLeaseR\x06leases\"\xe8\x04\n" +
	"\x0eRadiusStatsMap\x12U\n" +
	"\fradius_stats\x18\x01 \x03(\v22.SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntryR\vradiusStats\x1am\n" +
	"\x10RadiusStatsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12C\n" +
	"\x05value\x18\x02 \x01(\v2-.SpaceX.API.Device.RadiusStatsMap.RadiusStatsR\x05value:\x028\x01\x1a\x8f\x03\n" +
	"\vRadiusStats\x12\x1d\n" +
	"\n" +
	"iface_name\x18\x01 \x01(\tR\tifaceName\x12#\n" +
	"\rtimeout_count\x18\x02 \x01(\rR\ftimeoutCount\x120\n" +
	"\x14access_request_count\x18\x03 \x01(\rR\x12accessRequestCount\x12.\n" +
	"\x13access_accept_count\x18\x04 \x01(\rR\x11accessAcceptCount\x12.\n" +
	"\x13access_reject_count\x18\x05 \x01(\rR\x11accessRejectCount\x124\n" +
	"\x16access_challenge_count\x18\x06 \x01(\rR\x14accessChallengeCount\x128\n" +
	"\x18accounting_request_count\x18\a \x01(\rR\x16accountingRequestCount\x12:\n" +
	"\x19accounting_response_count\x18\b \x01(\rR\x17accountingResponseCount\"\xcd\x02\n" +
	"\bPoeStats\x128\n" +
	"\tpoe_state\x18\x01 \x01(\x0e2\x1b.SpaceX.API.Device.PoeStateR\bpoeState\x12\x1b\n" +
	"\tpoe_power\x18\x02 \x01(\x02R\bpoePower\x12=\n" +
	"\x1bpoe_faults_fast_overcurrent\x18\x03 \x01(\rR\x18poeFaultsFastOvercurrent\x12=\n" +
	"\x1bpoe_faults_slow_overcurrent\x18\x04 \x01(\rR\x18poeFaultsSlowOvercurrent\x124\n" +
	"\x16poe_faults_overvoltage\x18\x05 \x01(\rR\x14poeFaultsOvervoltage\x126\n" +
	"\x17poe_faults_undervoltage\x18\x06 \x01(\rR\x15poeFaultsUndervoltage\"\xe3\x01\n" +
	"\x17WifiSoftwareUpdateStats\x12@\n" +
	"\x05state\x18\x01 \x01(\x0e2*.SpaceX.API.Device.WifiSoftwareUpdateStateR\x05state\x12<\n" +
	...
	"\x10A_AN_AC_AX_MIXED\x10\f\x12\x10\n" +
	"\fA_N_AC_MIXED\x10\r\x12\x13\n" +
	"\x0fA_N_AC_AX_MIXED\x10\x0e*U\n" +
	"\fWifiSecurity\x12\x19\n" +
	"\x15WIFI_SECURITY_UNKNOWN\x10\x00\x12\b\n" +
	"\x04OPEN\x10\x01\x12\b\n" +
	"\x04WPA2\x10\x02\x12\b\n" +
	"\x04WPA3\x10\x03\x12\f\n" +
	"\bWPA2WPA3\x10\x04*/\n" +
	"\bProtocol\x12\a\n" +
	"\x03TCP\x10\x00\x12\a\n" +
	"\x03UDP\x10\x01\x12\a\n" +
	"\x03TLS\x10\x02\x12\b\n" +
	"\x04DTLS\x10\x03*\xf2\x02\n" +
	"\x17WifiSoftwareUpdateState\x12\v\n" +
	"\aNOT_RUN\x10\x00\x12\x1a\n" +
	"\x16GETTING_TARGET_VERSION\x10\x01\x12\x1c\n" +
	"\x18DOWNLOADING_UPDATE_IMAGE\x10\x02\x12\f\n" +
	"\bFLASHING\x10\x03\x12\x16\n" +
	"\x12NO_UPDATE_REQUIRED\x10\x04\x12\x12\n" +
	"\x0eREBOOT_PENDING\x10\x05\x12!\n" +
	"\x1dGETTING_TARGET_VERSION_FAILED\x10\x06\x12$\n" +
	" GETTING_TARGET_VERSION_EXHAUSTED\x10\a\x12\x15\n" +
	"\x11NO_VALID_ARTIFACT\x10\b\x12\x14\n" +
	"\x10ILLEGAL_ARTIFACT\x10\t\x12#\n" +
	"\x1fDOWNLOADING_UPDATE_IMAGE_FAILED\x10\n" +
	"\x12&\n" +
	"\"DOWNLOADING_UPDATE_IMAGE_EXHAUSTED\x10\v\x12\x13\n" +
	"\x0fFLASHING_FAILED\x10\fB\x17Z\x15spacex.com/api/deviceb\x06proto3"

var (
	file_spacex_api_device_wifi_util_proto_rawDescOnce sync.Once
	file_spacex_api_device_wifi_util_proto_rawDescData []byte
)

func file_spacex_api_device_wifi_util_proto_rawDescGZIP() []byte {
	file_spacex_api_device_wifi_util_proto_rawDescOnce.Do(func() {
		file_spacex_api_device_wifi_util_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacex_api_device_wifi_util_proto_rawDesc), len(file_spacex_api_device_wifi_util_proto_rawDesc)))
	})
	return file_spacex_api_device_wifi_util_proto_rawDescData
}

var file_spacex_api_device_wifi_util_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_spacex_api_device_wifi_util_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_spacex_api_device_wifi_util_proto_goTypes = []any{
	...
	(*InflatedBasicServiceSet)(nil),    // 8: SpaceX.API.Device.InflatedBasicServiceSet
	(*DhcpLease)(nil),                  // 9: SpaceX.API.Device.DhcpLease
	(*DhcpServer)(nil),                 // 10: SpaceX.API.Device.DhcpServer
	(*RadiusStatsMap)(nil),             // 11: SpaceX.API.Device.RadiusStatsMap
	(*PoeStats)(nil),                   // 12: SpaceX.API.Device.PoeStats
	(*WifiSoftwareUpdateStats)(nil),    // 13: SpaceX.API.Device.WifiSoftwareUpdateStats
	nil,                                // 14: SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry
	(*RadiusStatsMap_RadiusStats)(nil), // 15: SpaceX.API.Device.RadiusStatsMap.RadiusStats
}
var file_spacex_api_device_wifi_util_proto_depIdxs = []int32{
	...
	9,  // 1: SpaceX.API.Device.DhcpServer.leases:type_name -> SpaceX.API.Device.DhcpLease
	14, // 2: SpaceX.API.Device.RadiusStatsMap.radius_stats:type_name -> SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry
	...
	15, // 5: SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry.value:type_name -> SpaceX.API.Device.RadiusStatsMap.RadiusStats
